...
def create_sample_data():
    ...
    data = [
        {
            "subdomain": "ssh.0x10.cloud",
            "type": "default_creds",
            "severity": "HIGH",
            "date": "2026-03-10",
        },
        {
            "subdomain": "blog.0x10.cloud",
            "type": "no_https",
            "severity": "LOW",
            "date": "2026-03-10",
        },
        ...
        {
            "subdomain": "ftp.0x10.cloud",
            "type": "default_creds",
            "severity": "HIGH",
            "date": "2026-03-10",
        },
        {
            "subdomain": "cdn.0x10.cloud",
            "type": "missing_header",
            "severity": "LOW",
            "date": "2026-03-10",
        },
        {
            "subdomain": "db.0x10.cloud",
            "type": "open_port",
            "severity": "HIGH",
            "date": "2026-03-11",
        },
